...
% Fahrzeug-Auftrag (kfz_order)
\newcommand{\kfzauftrag} {Fahrzeug-Auftrag}
\newcommand{\kfzauftragsformel} {folgender Auftrag wird hiermit bestätigt:}
\newcommand{\fahrzeugdaten} {Fahrzeugdaten}
\newcommand{\kennzeichenlabel} {Kennzeichen}
\newcommand{\herstellerlabel} {Hersteller}
\newcommand{\modelllabel} {Modell}
\newcommand{\finlabel} {FIN}
\newcommand{\kmstandlabel} {km-Stand}
\newcommand{\bringeterminlabel} {Bringe-Termin}
\newcommand{\fertigstellunglabel} {Fertigstellung}
\newcommand{\arbeitsanweisungen} {Arbeitsanweisungen}
\newcommand{\maengelliste} {Mängelliste}
\newcommand{\mangelcode} {Code}
\newcommand{\mangelbeschreibung} {Beschreibung}
\newcommand{\mangelkategorie} {Kategorie}
\newcommand{\anrlabel} {Anr.-Nr.}
\newcommand{\auftraggeber} {Auftraggeber}
\newcommand{\auftragnehmer} {Auftragnehmer}
\newcommand{\verbauteersatzteile} {Verbaute Ersatzteile}
\newcommand{\ausgefuehrtearbeiten} {Ausgeführte Arbeiten}
\newcommand{\ersatzteilebestaetigung} {Ich habe sämtliche Ersatzteile und ausgeführte Arbeiten i.d. obigen Liste notiert. Unterschrift:}
\newcommand{\kundenunterschrift} {Kundenunterschrift:}
\newcommand{\endkontrolle} {Endkontrolle UND Probefahrt durchgeführt von:}
\newcommand{\repauftrag} {Rep.-Auftrag}
